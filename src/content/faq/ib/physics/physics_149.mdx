...
summary: "The relationship between frequency, wavelength, and wave speed is given by the equation v = fλ, where v is wave speed, f is frequency, and λ is wavelength."
