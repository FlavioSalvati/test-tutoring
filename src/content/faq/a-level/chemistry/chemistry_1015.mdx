...
summary: "A nitrile is a compound containing a cyano group (-C≡N), while an amide is a compound containing a carbonyl group (-C=O) bonded to a nitrogen atom (-NH2 or -NHR)."
