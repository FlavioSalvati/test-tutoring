...
summary: "The motion of a resonating system is described by the equation x(t) = A sin(ωt + φ), where A is amplitude, ω is angular frequency, and φ is the phase constant."
