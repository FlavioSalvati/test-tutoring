---
title: "How do you calculate the volume of a pyramid with base area 20 cm² and height 9 cm?"
summary: "The volume of a pyramid is calculated using the formula; Volume = (1/3) × Base Area × Height."
